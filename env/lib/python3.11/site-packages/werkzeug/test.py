...
class Client:
    ...
    def get_cookie(
        self, key: str, domain: str = "0.0.0.0", path: str = "/"
    ) -> Cookie | None:
    ...
    def set_cookie(
        ...
        **kwargs: t.Any,
        ...
        .. versionchanged:: 2.3
            The ``domain`` parameter defaults to ``0.0.0.0``.
    ...
    def _add_cookies_to_wsgi(self, environ: WSGIEnvironment) -> None:
        ...
        server_name = url.hostname or "0.0.0.0"
        value = "; ".join(
    ...
    def run_wsgi_app(
        ...
        self._update_cookies_from_response(
            url.hostname or "0.0.0.0", url.path, rv[2].getlist("Set-Cookie")
        )
        return rv
...
def create_environ(*args: t.Any, **kwargs: t.Any) -> WSGIEnvironment:
    ...
    0.0.0.0:80) or a full path to the request with scheme, netloc port and
